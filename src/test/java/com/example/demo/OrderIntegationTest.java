...
public class OrderIntegationTest {
    ...
    public void createOrderTest() throws Exception {
        ...
        String str = "{\"orderStatus\":\"Order Received\",\"orderCustomerId\":1234,\"orderShippingCharges\":74.6,\"orderTotal\":1294.55,\"itemEntityList\":[{\"itemId\":\"1\",\"orderItemName\":\"Ipad\",\"orderItemQty\":10,\"orderSubtotal\":3223.2,\"orderTax\":212.9,\"updatedTime\":null,\"isCancel\":null,\"orderEntity\":null}]}";
    ...
    public void updateOrderTest() throws Exception {
        String str = "{\"orderStatus\":\"Order Received\",\"orderCustomerId\":1234,\"orderShippingCharges\":74.6,\"orderTotal\":1294.55,\"itemEntityList\":[{\"orderItemName\":\"Ipad\",\"orderItemQty\":10,\"orderSubtotal\":3223.2,\"orderTax\":212.9,\"updatedTime\":null,\"isCancel\":null,\"orderEntity\":null}]}";

        MvcResult mvcResult = mockMvc.perform(MockMvcRequestBuilders.put("/updateOrder")
                .contentType(MediaType.APPLICATION_JSON).content(str))
